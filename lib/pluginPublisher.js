...
class PluginPublisher {
    ...
    async packagePlugin(pluginPath, manifest) {
    ...
    async publishPlugin(packagedPlugin) {
    ...
    async publishFromPath(pluginPath) {
        ...
        const packagedPlugin = await this.packagePlugin(pluginPath, validation.manifest);

        // Step 3: Publish plugin
        const result = await this.publishPlugin(packagedPlugin);
